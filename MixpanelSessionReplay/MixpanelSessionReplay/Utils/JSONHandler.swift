...
class JSONHandler {
    ...
    class func deserializeData(_ data: Data) -> MPObjectToParse? {
        ...
        do {
            ...
            Logger.error(message: "exception decoding object data")
        }
        return object
    }
    ...
    class func serializeJSONObject(_ obj: MPObjectToParse) -> Data? {
        ...
        guard JSONSerialization.isValidJSONObject(serializableJSONObject) else {
            Logger.warn(message: "object isn't valid and can't be serialized to JSON")
            return nil
        }
        ...
        do {
            ...
            Logger.error(message: "exception encoding api data")
        }
